                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="padding-bottom: 15px;">
                                                    ...
                                                    <span style="color: #ef4444; font-size: 22px; font-weight: 700;">${{ number_format($config->cycleUsageDollars(), 2) }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="padding-bottom: 15px; border-top: 1px solid #2a2a4e; padding-top: 15px;">
                                                    ...
                                                    <span style="color: #ef4444; font-size: 16px; font-weight: 600;">${{ number_format($config->overageCents() / 100, 2) }}</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
