...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <meta name="description" content="<?php echo e($ogMeta['description'] ?? 'CoreLink Development specializes in crafting intelligent, scalable web and mobile applications using cutting-edge AI technology.'); ?>">
        <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">

        <title><?php echo e(isset($ogMeta['title']) ? $ogMeta['title'] . ' | ' . config('app.name') : config('app.name', 'Laravel')); ?></title>

        <!-- Open Graph / Facebook -->
        <meta property="og:type" content="<?php echo e($ogMeta['type'] ?? 'website'); ?>">
        <meta property="og:url" content="<?php echo e($ogMeta['url'] ?? url()->current()); ?>">
        <meta property="og:title" content="<?php echo e($ogMeta['title'] ?? config('app.name')); ?>">
        <meta property="og:description" content="<?php echo e($ogMeta['description'] ?? 'CoreLink Development specializes in crafting intelligent, scalable web and mobile applications using cutting-edge AI technology.'); ?>">
        <meta property="og:image" content="<?php echo e((isset($ogMeta['image']) && $ogMeta['image']) ? $ogMeta['image'] : url('/images/og-default.png')); ?>">

        <!-- Twitter -->
        <meta property="twitter:card" content="summary_large_image">
        <meta property="twitter:url" content="<?php echo e($ogMeta['url'] ?? url()->current()); ?>">
        <meta property="twitter:title" content="<?php echo e($ogMeta['title'] ?? config('app.name')); ?>">
        <meta property="twitter:description" content="<?php echo e($ogMeta['description'] ?? 'CoreLink Development specializes in crafting intelligent, scalable web and mobile applications using cutting-edge AI technology.'); ?>">
        <meta property="twitter:image" content="<?php echo e((isset($ogMeta['image']) && $ogMeta['image']) ? $ogMeta['image'] : url('/images/og-default.png')); ?>">

        <!-- Favicon -->
        <link rel="icon" type="image/png" href="/images/favicon.png">

        <?php if (! (request()->is('admin/*') || request()->is('helpdesk/*'))): ?>
...
<?php /**PATH C:\Users\aaron\Code\corelink\resources\views/app.blade.php ENDPATH**/ ?>