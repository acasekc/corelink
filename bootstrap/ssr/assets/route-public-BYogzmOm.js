...
import { Heart, Users, Sparkles, ShieldCheck, Target, Rocket, Wrench, Monitor, Server, Layers, Globe, Cpu, Smartphone, Plug, ShoppingCart, ArrowLeft, Send, ArrowRight, Zap, Code2, Shield, AlertCircle, ChevronLeft, ChevronRight, Save, CheckCircle2, MessageSquare, Compass, Palette, Brain, Eye, TrendingUp, HeartHandshake, ExternalLink, X, Scale } from "lucide-react";
...
function isSafeIntent(url) {
  return typeof url === "string" && url.length > 0 && url.length < 1e3 && url.startsWith("/") && !url.startsWith("//") && (url.startsWith("/admin") || url.startsWith("/helpdesk"));
}
const Login = () => {
...
function IntakeForm({ meta, invite, prefill, draft, options }) {
  ...
  const STEPS = useMemo(() => buildSteps(), [options]);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-950 text-white py-10 px-4", children: [
    /* @__PURE__ */ jsx(SeoHead, { meta }),
    /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsx(Header, { step, totalSteps, title: currentStep.title, subtitle: currentStep.subtitle, savedAt }),
      /* @__PURE__ */ jsxs("div", { className: "bg-slate-900 rounded-xl border border-slate-800 p-6 md:p-8", children: [
        isReview ? /* @__PURE__ */ jsx(Review, { data, options, files, steps: STEPS.slice(0, -1) }) : /* @__PURE__ */ jsx(StepFields, { step: currentStep, data, errors, options, files, update, toggleMulti, setFile }),
        submitError && /* @__PURE__ */ jsxs("div", { className: "mt-6 flex items-start gap-2 rounded-lg border border-red-500/40 bg-red-500/10 p-3 text-sm text-red-200", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-8 flex items-center justify-between", children: [
          ...
          isReview ? /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: submitting ? "Submitting…" : /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-500 mt-4 text-center", children: "Your progress is saved automatically. You can close this page and come back to your link any time." })
    ] })
  ] });
}
IntakeForm.layout = (page) => /* @__PURE__ */ jsx("div", { className: "bg-slate-950 min-h-screen", children: page });
function Header({ step, totalSteps, title, subtitle, savedAt }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-2", children: [
      /* @__PURE__ */ jsxs("span", { className: "text-xs uppercase tracking-wide text-slate-400", children: [
        "Step ",
        step + 1,
        " of ",
        totalSteps
      ] }),
      savedAt && /* @__PURE__ */ jsxs("span", { className: "text-xs text-slate-500 flex items-center gap-1", children: [
        /* @__PURE__ */ jsx(Save, { className: "w-3 h-3" }),
        " Saved ",
        new Date(savedAt).toLocaleTimeString()
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "h-1 w-full bg-slate-800 rounded-full overflow-hidden mb-4", children: /* @__PURE__ */ jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsx("h1", { className: "text-2xl md:text-3xl font-bold", children: title }),
    subtitle && /* @__PURE__ */ jsx("p", { className: "text-slate-400 mt-1 text-sm", children: subtitle })
  ] });
}
function StepFields({ step, data, errors, options, files, update, toggleMulti, setFile }) {
  return /* @__PURE__ */ jsx("div", { className: "space-y-5", children: (step.fields || []).map((field) => {
...
function Field({ field, value, error, options, file, update, toggleMulti, setFile }) {
  const labelEl = /* @__PURE__ */ jsxs("label", { className: "block text-sm font-medium text-slate-200 mb-1.5", children: [
    field.label,
    field.required && /* @__PURE__ */ jsx("span", { className: "text-red-400 ml-1", children: "*" })
  ] });
  const help = field.help && /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-500 mt-1", children: field.help });
  const errEl = error && /* @__PURE__ */ jsx("p", { className: "text-xs text-red-400 mt-1", children: error });
  const baseInput = "w-full px-3.5 py-2.5 rounded-lg bg-slate-800/70 border focus:outline-none text-white placeholder-slate-500 " + (error ? "border-red-500/80 focus:border-red-400" : "border-slate-700 focus:border-blue-500");
  ...
  switch (field.type) {
    ...
    case "tel":
    case "date":
      return /* @__PURE__ */ jsxs("div", { "data-field-key": field.key, className: "scroll-mt-24", children: [
        labelEl,
        /* @__PURE__ */ jsx(
          "input",
          {
        ...
        /* @__PURE__ */ jsxs(
          "select",
          {
            ...
            children: [
              ...
              Object.entries(opts).map(([key, label]) => /* @__PURE__ */ jsx("option", { value: key, children: label }, key))
            ]
          }
        ),
        help,
    ...
    case "radio": {
      ...
      return /* @__PURE__ */ jsxs("div", { "data-field-key": field.key, className: "scroll-mt-24", children: [
        labelEl,
        /* @__PURE__ */ jsx("div", { className: groupClassName, children: /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: Object.entries(opts).map(([key, label]) => /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
            onClick: () => update(field.key, key),
            "aria-invalid": Boolean(error),
            className: "px-4 py-2 rounded-lg text-sm border transition " + (value === key ? "bg-blue-500/20 border-blue-500 text-white" : "bg-slate-800/40 border-slate-700 text-slate-300 hover:border-slate-500"),
            children: label
          },
          key
        )) }) }),
    ...
    case "multi": {
      ...
      return /* @__PURE__ */ jsxs("div", { "data-field-key": field.key, className: "scroll-mt-24", children: [
        labelEl,
        /* @__PURE__ */ jsx("div", { className: groupClassName, children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2", children: Object.entries(opts).map(([key, label]) => {
          ...
          return /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              "aria-invalid": Boolean(error),
              className: "px-3.5 py-2.5 rounded-lg text-sm border text-left flex items-center gap-2 transition " + (active ? "bg-blue-500/20 border-blue-500 text-white" : "bg-slate-800/40 border-slate-700 text-slate-300 hover:border-slate-500"),
              children: [
                /* @__PURE__ */ jsx(
                  "span",
                  {
                    className: "w-4 h-4 rounded border flex items-center justify-center shrink-0 " + (active ? "bg-blue-500 border-blue-500" : "border-slate-500"),
                    children: active && /* @__PURE__ */ jsx(CheckCircle2, { className: "w-3 h-3 text-white" })
                  }
                ),
                label
              ]
    ...
    case "file":
      return /* @__PURE__ */ jsxs("div", { "data-field-key": field.key, className: "scroll-mt-24", children: [
        labelEl,
        /* @__PURE__ */ jsx("div", { className: groupClassName, children: /* @__PURE__ */ jsx(
          "input",
          {
            type: "file",
            name: field.key,
        ...
        file && /* @__PURE__ */ jsxs("p", { className: "text-xs text-slate-400 mt-1", children: [
          "Selected: ",
          file.name
        ] }),
        help,
...
function Review({ data, options, files, steps }) {
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold mb-1", children: "Review your answers" }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-slate-400", children: "Take a moment to double-check before submitting. You can go back to fix anything." })
    ] }),
    steps.map((step, idx) => /* @__PURE__ */ jsxs("div", { className: "border border-slate-800 rounded-lg overflow-hidden", children: [
      /* @__PURE__ */ jsx("div", { className: "bg-slate-800/50 px-4 py-2 text-sm font-semibold text-slate-200", children: step.title }),
      /* @__PURE__ */ jsx("dl", { className: "p-4 space-y-2", children: (step.fields || []).map((field) => {
        if (field.requiresValue && !field.requiresValue(data)) return null;
        const rendered = renderValue(field, data[field.key], options, files);
        if (!rendered) return null;
        return /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-1 text-sm", children: [
          /* @__PURE__ */ jsx("dt", { className: "text-slate-400", children: field.label }),
          /* @__PURE__ */ jsx("dd", { className: "sm:col-span-2 text-slate-100 break-words", children: rendered })
        ] }, field.key);
      }) })
    ] }, idx))
  ] });
...
function IntakeSubmitted({ meta }) {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-950 text-white flex items-center justify-center px-4", children: [
    /* @__PURE__ */ jsx(SeoHead, { meta }),
    /* @__PURE__ */ jsxs("div", { className: "max-w-md text-center bg-slate-900 border border-slate-800 rounded-xl p-8", children: [
      /* @__PURE__ */ jsx("div", { className: "mx-auto w-14 h-14 rounded-full bg-emerald-500/20 flex items-center justify-center mb-5", children: /* @__PURE__ */ jsx(CheckCircle2, { className: "w-8 h-8 text-emerald-400" }) }),
      /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold mb-2", children: "Thanks — we got it" }),
      /* @__PURE__ */ jsx("p", { className: "text-slate-400 text-sm mb-6", children: "Your intake is in our queue. A team member will review your answers and reach out within 1–2 business days to schedule a scoping call." }),
      /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-500", children: "If anything's changed, just reply to the confirmation email we sent you." })
    ] })
  ] });
}
IntakeSubmitted.layout = (page) => /* @__PURE__ */ jsx("div", { className: "bg-slate-950 min-h-screen", children: page });
const __vite_glob_0_61 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: IntakeSubmitted
}, Symbol.toStringTag, { value: "Module" }));
const Privacy = ({ meta }) => {
...
export {
  __vite_glob_0_65 as _,
  __vite_glob_0_64 as a,
  __vite_glob_0_63 as b,
  consumeIntent as c,
  __vite_glob_0_62 as d,
  __vite_glob_0_61 as e,
  __vite_glob_0_60 as f,
  __vite_glob_0_59 as g,
  __vite_glob_0_58 as h,
  __vite_glob_0_45 as i,
  __vite_glob_0_44 as j,
  __vite_glob_0_43 as k,
  __vite_glob_0_42 as l,
  __vite_glob_0_36 as m,
